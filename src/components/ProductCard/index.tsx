...
export default function ProductCard(props: any) {
    const { id, name, price, imageURL, category, className, slug } = props;
    return (
        <Link href={`/catalog/${slug}/${id}`} id={id} className="relative cursor-pointer group rounded-2xl border border-amber-500 flex flex-col w-full pt-4 pb-6 px-4 md:px-6">
