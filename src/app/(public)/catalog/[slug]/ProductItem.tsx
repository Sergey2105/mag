    ...
    return (
        <>
            {/* <Link
                ...
                id={id}
                className={cn(
                    "relative cursor-pointer overflow-hidden group rounded-2xl border border-amber-500 flex flex-col w-full pt-3 pb-6 px-3 lg:px-6 lg:pt-6 lg:pb-7 2xl:px-4 2xl:pt-4 2xl:pb-4",
                    className,
                )}
            >
